...
// Client wrapper so the LinkedIn click can fire a GA event tagged with which
// person's profile was opened (ohad / itay).
export function LinkedinLink({
  ...
  return (
    <a
      ...
      dir="ltr"
      onClick={() => trackEvent("linkedin_click", { person })}
