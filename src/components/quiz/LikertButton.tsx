...
export function LikertButton({ value, label, selected, onClick }: LikertButtonProps) {
  ...
  return (
    <motion.button
      ...
      className={cn(
        "relative flex w-full items-center justify-between overflow-hidden rounded-xl border-2 border-gray/80 bg-white px-5 text-start text-base font-semibold text-foreground cursor-pointer",
